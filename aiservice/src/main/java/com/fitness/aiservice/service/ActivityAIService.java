...
public class ActivityAIService {
    ...
    private Recommendation processAiResponse(Activity activity, String aiResponse){
        try{
            ...
            log.info("Parsed from AI Response: {}" + jsonContent);
    ...
    private List<String> extractSafetyGuidelines(JsonNode safetyNode) {
        ...
        return safety.isEmpty() ? Collections.singletonList("No specific safety guidelines.") : safety;
    }
    ...
    private String createPromptForActivity(Activity activity) {
        return String.format("""
                Analyze the firness activity and give detailed recommendations int the following
                {
                    "analysis":{
